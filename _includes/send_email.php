...
$mail->Subject = 'New Reservation Request from '.$_POST["fname"];
...
$mail->Body = 'Name: '.$_POST["fname"].' '.$_POST["lname"].nl2br('<br>Phone Number: ').$_POST["phone"]
            .nl2br('<br>Email: ').$_POST["email"].nl2br('<br>Check-In Date: ').$_POST["arr"].nl2br('<br>Check-Out Date: ').$_POST["dep"]
            .nl2br('<br>Number of Guests: ').$_POST["guests"].nl2br('<br>Preferred Room: ').$_POST["room-type"].nl2br('<br>Message: <br>').nl2br($_POST["inquiry"]);
$mail->AltBody = 'Name: '.$_POST["fname"].' '.$_POST["lname"].nl2br('\n Phone Number: ').$_POST["phone"]
                .nl2br('\n Email: ').$_POST["email"].nl2br('\n Check-In Date: ').$_POST["arr"].nl2br('\n Check-Out Date: ').$_POST["dep"]
                .nl2br('\n Number of Guests: ').$_POST["guests"].nl2br('\n Preferred Room: ').$_POST["room-type"].nl2br('\n Message: \n').nl2br($_POST["inquiry"]);

//send the message, check for errors
if (!$mail->send()) {
    // echo 'Mailer Error: ' . $mail->ErrorInfo;
    header('Location: ../request-your-stay?failure');

} else {
    // echo 'Message sent!';
    header('Location: ../request-your-stay?success');
    //Section 2: IMAP
